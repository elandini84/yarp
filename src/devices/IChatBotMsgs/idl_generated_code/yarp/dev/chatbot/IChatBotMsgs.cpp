...
#include <yarp/dev/chatbot/IChatBotMsgs.h>
...
class IChatBotMsgs_backupBotRPC_helper :
        public yarp::os::Portable
{
public:
    IChatBotMsgs_backupBotRPC_helper() = default;
    bool write(yarp::os::ConnectionWriter& connection) const override;
    bool read(yarp::os::ConnectionReader& connection) override;
    ...
    static constexpr size_t s_cmd_len{1};
    static constexpr size_t s_reply_len{2};
    static constexpr const char* s_prototype{"return_backupBot IChatBotMsgs::backupBotRPC()"};
    static constexpr const char* s_help{""};
};

// restoreBotRPC helper class declaration
class IChatBotMsgs_restoreBotRPC_helper :
        public yarp::os::Portable
{
public:
    IChatBotMsgs_restoreBotRPC_helper() = default;
    explicit IChatBotMsgs_restoreBotRPC_helper(const std::string& botToRestore);
    bool write(yarp::os::ConnectionWriter& connection) const override;
    bool read(yarp::os::ConnectionReader& connection) override;
    ...
    static constexpr size_t s_cmd_len{2};
    static constexpr size_t s_reply_len{1};
    static constexpr const char* s_prototype{"bool IChatBotMsgs::restoreBotRPC(const std::string& botToRestore)"};
    static constexpr const char* s_help{""};
};
...
bool IChatBotMsgs_backupBotRPC_helper::write(yarp::os::ConnectionWriter& connection) const
{
    return cmd.write(connection);
}

bool IChatBotMsgs_backupBotRPC_helper::read(yarp::os::ConnectionReader& connection)
{
    return reply.read(connection);
}

bool IChatBotMsgs_backupBotRPC_helper::Command::write(yarp::os::ConnectionWriter& connection) const
{
    yarp::os::idl::WireWriter writer(connection);
    if (!writer.writeListHeader(s_cmd_len)) {
        return false;
...
bool IChatBotMsgs_backupBotRPC_helper::Command::read(yarp::os::ConnectionReader& connection)
{
    yarp::os::idl::WireReader reader(connection);
    if (!reader.readListHeader()) {
        reader.fail();
...
bool IChatBotMsgs_backupBotRPC_helper::Command::write(const yarp::os::idl::WireWriter& writer) const
{
    if (!writeTag(writer)) {
        return false;
    }
...
bool IChatBotMsgs_backupBotRPC_helper::Command::writeTag(const yarp::os::idl::WireWriter& writer) const
{
    if (!writer.writeTag(s_tag, 1, s_tag_len)) {
        return false;
    }
...
bool IChatBotMsgs_backupBotRPC_helper::Command::writeArgs(const yarp::os::idl::WireWriter& writer [[maybe_unused]]) const
{
    return true;
}

bool IChatBotMsgs_backupBotRPC_helper::Command::read(yarp::os::idl::WireReader& reader)
{
    if (!readTag(reader)) {
        return false;
    }
...
bool IChatBotMsgs_backupBotRPC_helper::Command::readTag(yarp::os::idl::WireReader& reader)
{
    std::string tag = reader.readTag(s_tag_len);
    if (reader.isError()) {
        return false;
...
bool IChatBotMsgs_backupBotRPC_helper::Command::readArgs(yarp::os::idl::WireReader& reader)
{
    if (!reader.noMore()) {
        reader.fail();
        return false;
...
bool IChatBotMsgs_backupBotRPC_helper::Reply::write(yarp::os::ConnectionWriter& connection) const
{
    yarp::os::idl::WireWriter writer(connection);
    return write(writer);
}

bool IChatBotMsgs_backupBotRPC_helper::Reply::read(yarp::os::ConnectionReader& connection)
{
    yarp::os::idl::WireReader reader(connection);
    return read(reader);
}

bool IChatBotMsgs_backupBotRPC_helper::Reply::write(const yarp::os::idl::WireWriter& writer) const
{
    if (!writer.isNull()) {
        if (!writer.writeListHeader(s_reply_len)) {
            return false;
...
bool IChatBotMsgs_backupBotRPC_helper::Reply::read(yarp::os::idl::WireReader& reader)
{
    if (!reader.readListReturn()) {
        return false;
    }
...
void IChatBotMsgs_backupBotRPC_helper::call(IChatBotMsgs* ptr)
{
    reply.return_helper = ptr->backupBotRPC();
}

// restoreBotRPC helper class implementation
IChatBotMsgs_restoreBotRPC_helper::IChatBotMsgs_restoreBotRPC_helper(const std::string& botToRestore) :
        cmd{botToRestore}
{
}

bool IChatBotMsgs_restoreBotRPC_helper::write(yarp::os::ConnectionWriter& connection) const
{
    return cmd.write(connection);
}

bool IChatBotMsgs_restoreBotRPC_helper::read(yarp::os::ConnectionReader& connection)
{
    return reply.read(connection);
}

IChatBotMsgs_restoreBotRPC_helper::Command::Command(const std::string& botToRestore) :
        botToRestore{botToRestore}
{
}

bool IChatBotMsgs_restoreBotRPC_helper::Command::write(yarp::os::ConnectionWriter& connection) const
{
    yarp::os::idl::WireWriter writer(connection);
    if (!writer.writeListHeader(s_cmd_len)) {
        return false;
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::read(yarp::os::ConnectionReader& connection)
{
    yarp::os::idl::WireReader reader(connection);
    if (!reader.readListHeader()) {
        reader.fail();
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::write(const yarp::os::idl::WireWriter& writer) const
{
    if (!writeTag(writer)) {
        return false;
    }
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::writeTag(const yarp::os::idl::WireWriter& writer) const
{
    if (!writer.writeTag(s_tag, 1, s_tag_len)) {
        return false;
    }
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::writeArgs(const yarp::os::idl::WireWriter& writer) const
{
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::read(yarp::os::idl::WireReader& reader)
{
    if (!readTag(reader)) {
        return false;
    }
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::readTag(yarp::os::idl::WireReader& reader)
{
    std::string tag = reader.readTag(s_tag_len);
    if (reader.isError()) {
        return false;
...
bool IChatBotMsgs_restoreBotRPC_helper::Command::readArgs(yarp::os::idl::WireReader& reader)
{
    if (reader.noMore()) {
        reader.fail();
        return false;
...
bool IChatBotMsgs_restoreBotRPC_helper::Reply::write(yarp::os::ConnectionWriter& connection) const
{
    yarp::os::idl::WireWriter writer(connection);
    return write(writer);
}

bool IChatBotMsgs_restoreBotRPC_helper::Reply::read(yarp::os::ConnectionReader& connection)
{
    yarp::os::idl::WireReader reader(connection);
    return read(reader);
}

bool IChatBotMsgs_restoreBotRPC_helper::Reply::write(const yarp::os::idl::WireWriter& writer) const
{
    if (!writer.isNull()) {
        if (!writer.writeListHeader(s_reply_len)) {
            return false;
...
bool IChatBotMsgs_restoreBotRPC_helper::Reply::read(yarp::os::idl::WireReader& reader)
{
    if (!reader.readListReturn()) {
        return false;
    }
...
void IChatBotMsgs_restoreBotRPC_helper::call(IChatBotMsgs* ptr)
{
...
return_backupBot IChatBotMsgs::backupBotRPC()
{
    if (!yarp().canWrite()) {
        yError("Missing server method '%s'?", IChatBotMsgs_backupBotRPC_helper::s_prototype);
    }
    IChatBotMsgs_backupBotRPC_helper helper{};
    bool ok = yarp().write(helper, helper);
    return ok ? helper.reply.return_helper : return_backupBot{};
}

bool IChatBotMsgs::restoreBotRPC(const std::string& botToRestore)
{
    if (!yarp().canWrite()) {
        yError("Missing server method '%s'?", IChatBotMsgs_restoreBotRPC_helper::s_prototype);
    }
    IChatBotMsgs_restoreBotRPC_helper helper{botToRestore};
    bool ok = yarp().write(helper, helper);
    return ok ? helper.reply.return_helper : bool{};
}
...
std::vector<std::string> IChatBotMsgs::help(const std::string& functionName)
{
    ...
    if (showAll) {
        ...
        helpString.emplace_back(IChatBotMsgs_backupBotRPC_helper::s_tag);
        helpString.emplace_back(IChatBotMsgs_restoreBotRPC_helper::s_tag);
        ...
        if (functionName == IChatBotMsgs_backupBotRPC_helper::s_tag) {
            helpString.emplace_back(IChatBotMsgs_backupBotRPC_helper::s_prototype);
        }
        if (functionName == IChatBotMsgs_restoreBotRPC_helper::s_tag) {
            helpString.emplace_back(IChatBotMsgs_restoreBotRPC_helper::s_prototype);
        }
...
bool IChatBotMsgs::read(yarp::os::ConnectionReader& connection)
{
    ...
    while (tag_len <= max_tag_len && !reader.isError()) {
        ...
        if (tag == IChatBotMsgs_backupBotRPC_helper::s_tag) {
            IChatBotMsgs_backupBotRPC_helper helper;
            if (!helper.cmd.readArgs(reader)) {
                return false;
            }
        ...
        if (tag == IChatBotMsgs_restoreBotRPC_helper::s_tag) {
            IChatBotMsgs_restoreBotRPC_helper helper;
            if (!helper.cmd.readArgs(reader)) {
                return false;
            }
