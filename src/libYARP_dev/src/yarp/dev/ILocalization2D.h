...
constexpr yarp::conf::vocab32_t VOCAB_NAV_GET_CURRENT_COV       = yarp::os::createVocab('g','c','o','v');
constexpr yarp::conf::vocab32_t VOCAB_NAV_SET_INITIAL_COV       = yarp::os::createVocab('i','c','o','v');
